...
async def test_1(dut):
    ...
    dut.pattern_in.value = [0, 0, 0, 0, 1, 3, 5]
...
async def test_2(dut):
    ...
    dut.pattern_in.value = [0, 0, 0, 0, 2, 3, 4]
    dut.pattern_length.value = 3
    await Timer(1, units="ns")
...
async def test_3(dut):
    ...
    dut.pattern_in.value = [0, 0, 0, 3, 2, 4, 7]
...
async def test_4(dut):
    ...
    dut.pattern_in.value = [3, 5, 4, 3, 2, 4, 7]
...
async def test_5(dut):
    ...
    dut.pattern_in.value = [2, 5, 1, 3, 2, 4, 7]
    dut.pattern_length.value = 7
    await Timer(1, units="ns")
    assert dut.pattern_valid_out.value == 0
    await Timer(1, units="ns")
